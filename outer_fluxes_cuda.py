...
def outer_dGx_pos(globaldata, idx, power, vl_const, gamma, store, shared, temp1, temp2, sum_delx_delf, sum_dely_delf):
...
@cuda.jit(device=True)
def outer_dGx_neg(globaldata, idx, power, vl_const, gamma, store, shared, temp1, temp2, sum_delx_delf, sum_dely_delf):
...
@cuda.jit(device=True)
def outer_dGy_pos(globaldata, idx, power, vl_const, gamma, store, shared, temp1, temp2, sum_delx_delf, sum_dely_delf):
