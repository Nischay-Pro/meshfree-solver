...
def outer_dGx_pos(globaldata_local, globaldata_ghost, idx, configData):
...
def outer_dGx_neg(globaldata_local, globaldata_ghost, idx, configData):
...
def outer_dGy_pos(globaldata_local, globaldata_ghost, idx, configData):
