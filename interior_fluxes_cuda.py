...
def interior_dGx_pos(x, y, nx_gpu, ny_gpu, flag_1_gpu, min_dist, nbhs, conn, xpos_nbhs, xpos_conn, prim, q, maxminq, dq, flux_res, power, vl_const, gamma, interior):
...
@cuda.jit(inline=True)
def interior_dGx_neg(x, y, nx_gpu, ny_gpu, flag_1_gpu, min_dist, nbhs, conn, xneg_nbhs, xneg_conn, prim, q, maxminq, dq, flux_res, power, vl_const, gamma, interior):
    ...
    for itm in xneg_conn[idx][:xneg_nbhs[idx]]:
        ...
        limiters_cuda.venkat_limiter(qtilde_shared, q, maxminq, dq, nbhs, conn, x, y, min_dist, idx, vl_const, other_shared, delx, dely, gamma)
        split_fluxes_cuda.flux_Gxn(nx, ny, other_shared, addop)

        limiters_cuda.venkat_limiter(qtilde_shared, q, maxminq, dq, nbhs, conn, x, y, min_dist, itm, vl_const, other_shared, delx, dely, gamma)
        split_fluxes_cuda.flux_Gxn(nx, ny, other_shared, subop)
...
@cuda.jit(inline=True)
def interior_dGy_pos(x, y, nx_gpu, ny_gpu, flag_1_gpu, min_dist, nbhs, conn, ypos_nbhs, ypos_conn, prim, q, maxminq, dq, flux_res, power, vl_const, gamma, interior):
...
@cuda.jit(inline=True)
def interior_dGy_neg(x, y, nx_gpu, ny_gpu, flag_1_gpu, min_dist, nbhs, conn, yneg_nbhs, yneg_conn, prim, q, maxminq, dq, flux_res, power, vl_const, gamma, interior):
