...
function wallindices_flux_residual(globaldata, configData, wallindices, phi_i, phi_k)
	...
	for itm in wallindices
		# println(itm)
		wall_dGx_pos(globaldata, itm, configData, phi_i, phi_k, Gxp)
		wall_dGx_neg(globaldata, itm, configData, phi_i, phi_k, Gxn)
		wall_dGy_neg(globaldata, itm, configData, phi_i, phi_k, Gyn)
		# GTemp =
