function cal_flux_residual_kernel(gpuGlobalDataCommon, gpuConfigData)
	...
	if idx > 0 && idx <= gpuGlobalDataCommon[1,end]
		...
		if flag1 == gpuConfigData[17]
			wall_kernel(gpuGlobalDataCommon, idx, gpuConfigData)
		elseif flag1 == gpuConfigData[18]
			interior_kernel(gpuGlobalDataCommon, idx, gpuConfigData)
			# sync_threads()
		elseif flag1 == gpuConfigData[19]
			outer_kernel(gpuGlobalDataCommon, idx, gpuConfigData)
			# sync_threads()
		# else
...
@inline function wall_kernel(gpuGlobalDataCommon, idx, gpuConfigData)
...
@inline function interior_kernel(gpuGlobalDataCommon, idx, gpuConfigData)
	gpuGlobalDataCommon[35, idx] = 0.0
	gpuGlobalDataCommon[36, idx] = 0.0
	gpuGlobalDataCommon[37, idx] = 0.0
	gpuGlobalDataCommon[38, idx] = 0.0
...
@inline function outer_kernel(gpuGlobalDataCommon, idx, gpuConfigData)
	gpuGlobalDataCommon[35, idx] = 0.0
	gpuGlobalDataCommon[36, idx] = 0.0
	gpuGlobalDataCommon[37, idx] = 0.0
	gpuGlobalDataCommon[38, idx] = 0.0
