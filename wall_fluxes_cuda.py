...
def wall_dGx_pos(x, y, nx_gpu, ny_gpu, min_dist, nbhs, conn, xpos_nbhs, xpos_conn, xneg_nbhs, xneg_conn, ypos_nbhs, ypos_conn, yneg_nbhs, yneg_conn, prim, q, maxminq, dq, flux_res, idx, power, vl_const, gamma, store, shared, sum_delx_delf, sum_dely_delf, qtilde_shared):
...
@cuda.jit(device=True)
def wall_dGx_neg(x, y, nx_gpu, ny_gpu, min_dist, nbhs, conn, xpos_nbhs, xpos_conn, xneg_nbhs, xneg_conn, ypos_nbhs, ypos_conn, yneg_nbhs, yneg_conn, prim, q, maxminq, dq, flux_res, idx, power, vl_const, gamma, store, shared, sum_delx_delf, sum_dely_delf, qtilde_shared):
...
@cuda.jit(device=True)
def wall_dGy_neg(x, y, nx_gpu, ny_gpu, min_dist, nbhs, conn, xpos_nbhs, xpos_conn, xneg_nbhs, xneg_conn, ypos_nbhs, ypos_conn, yneg_nbhs, yneg_conn, prim, q, maxminq, dq, flux_res, idx, power, vl_const, gamma, store, shared, sum_delx_delf, sum_dely_delf, qtilde_shared):
