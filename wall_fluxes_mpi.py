...
def wall_dGx_pos(globaldata_local, globaldata_ghost, idx, configData):
...
def wall_dGx_neg(globaldata_local, globaldata_ghost, idx, configData):
...
def wall_dGy_neg(globaldata_local, globaldata_ghost, idx, configData):
