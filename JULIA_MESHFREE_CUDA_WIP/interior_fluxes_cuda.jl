...
function interior_dGx_pos_kernel(gpuGlobalDataCommon, idx, gpuConfigData, Gxp1, Gxp2, Gxp3, Gxp4)
    ...
    for iter in 56:75
        ...
        flux_Gxp_kernel(nx, ny, result1,result2,result3,result4, G_i1,G_i2,G_i3,G_i4)
...
function interior_dGx_neg_kernel(gpuGlobalDataCommon, idx, gpuConfigData, Gxn1, Gxn2, Gxn3, Gxn4)
    ...
    for iter in 76:95
        ...
        qtilde_to_primitive_kernel(qtilde_i, gpuConfigData, result1,result2,result3,result4)
        flux_Gxn_kernel(nx, ny, result1,result2,result3,result4, G_i1,G_i2,G_i3,G_i4)
        qtilde_to_primitive_kernel(qtilde_k, gpuConfigData, result1,result2,result3,result4)
        flux_Gxn_kernel(nx, ny, result1,result2,result3,result4, G_i1,G_i2,G_i3,G_i4)
        # CUDAnative.synchronize()
        sum_delx_delf1 += (G_k1 - G_i1) * dels_weights
...
function interior_dGy_pos_kernel(gpuGlobalDataCommon, idx, gpuConfigData, Gyp1, Gyp2, Gyp3, Gyp)
    power = gpuConfigData[6]
    limiter_flag = gpuConfigData[7]
...
function interior_dGy_neg_kernel(gpuGlobalDataCommon, idx, gpuConfigData, Gyn1, Gyn2, Gyn3, Gyn4)
    power = gpuConfigData[6]
    limiter_flag = gpuConfigData[7]
